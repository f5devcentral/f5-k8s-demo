...
sleep 30
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/sys/folder/~ocp

##
## Delete AS3 declaration
##
curl -k -u admin:admin -H "Content-Type: application/json" -X POST https://10.1.10.240/mgmt/shared/appsvcs/declare -H expect: -d '{ "class": "AS3", "declaration": { "class": "ADC", "schemaVersion": "3.1.0", "id": "f5demo", "ocp_AS3": { "class": "Tenant"   }  }  }'
...
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/self/~Common~10.130.0.4~14
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/self/~Common~10.130.0.3~14
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/self/~Common~vxlan-float
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/self/~Common~vxlan-local


curl -k -u admin:admin -H "Content-Type: application/json" -X PATCH -d '{"records":{}}' https://10.1.10.240/mgmt/tm/net/fdb/tunnel/~Common~openshift_vxlan

curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/tunnels/tunnel/~Common~openshift_vxlan
curl -k -u admin:admin -H "Content-Type: application/json" -X DELETE https://10.1.10.240/mgmt/tm/net/tunnels/vxlan/~Common~ose-vxlan
