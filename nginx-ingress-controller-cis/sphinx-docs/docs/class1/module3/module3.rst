Module – Container Ingress Services
===================================
...
During this excercise you will first configure CIS to use L4 TCP Load Balancing.
Then you will configure CIS to use L7 WAF policies.  These configurations will
be pushed to an F5 BIG-IP that is sitting outside the Kubernetes cluster.
